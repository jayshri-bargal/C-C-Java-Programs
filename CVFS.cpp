...
#define MAXINODE 50      //kiti files tayar karaychya tyachi size

#define READ 1      //this macros are for permission
#define WRITE 2
...
#define START 0          //these are positon for lseek function
#define CURRENT 1
#define END 2
...
int LseekFile(int fd,int size,int from)
{
    ...
    int stat_file(char *name)
    {
        ...
        printf("\n-------Statistical Informatio about file------\n");
        printf("File name:%s\n",temp->FileName);
         printf("Inode Number %d\n",temp->InodeNumber);
        printf("File size : %d\n",temp->FileSize);
        printf("Actual File size: %d\n",temp->FileActualSize);
    ...
    while(1)
    {
        ...
        else if(count==2)
        {
            ...
            else if(strcmp(command[0],"write")==0)   //write demo.txt
            {
                ...
                if(ret==-2)
                printf("ERROR : There is no Suuficient memory to Write\n");
                if(ret==-3)
        ...
        else if(count==3)
        {
            if(strcmp(command[0],"create")==0)
            {
                ...
                if(ret >=0)
                printf("File is Successfully Ceated with file Descriptor:%d",ret);
                if(ret==-1)
                printf("ERROR: Incorrect Parameters\n");
                if(ret==-2)
            ...
            else if(strcmp(command[0],"open")==0)
            {
                ...
                if(ret >= 0)
                printf("File is Successfully Opened with file Descriptor:%d",ret);
                if(ret==-1)
                printf("ERROR: Incorrect Parameters\n");
                if(ret==-2)
            ...
            else if(strcmp(command[0],"read")==0)    //read demo.txt 5
            {
                ...
                if(ret==-4)
                printf("ERROR: It is not Reguar file\n");
                if(ret==0)
